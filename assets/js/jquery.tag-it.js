...
(function($) {
    ...
    $.widget('ui.tagit', {
        ...
        _create: function() {
            ...
            // Add existing tags.
/*            if (this.options.tagValues) {
            	this.options.onTagClicked = this.options.tagValues;
            	for (var i = 0; i < this.options.tagValues.length; i++) {
            		self.createTag(jQuery.trim(this.options.tagValues[i]), null);

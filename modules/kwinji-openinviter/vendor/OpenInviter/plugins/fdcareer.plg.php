...
class fdcareer extends openinviter_base {
  ...
  public function getMyContacts() {
    ...
    foreach ($href_array as $key => $value) if (!empty($value)) {   $contacts[$value] = $names_array[$key]; }
    return $contacts;
  }
  ...
  public function sendMessage($session_id, $message, $contacts) {
    ...
    foreach ($contacts as $href => $name) {
      ...
      $post_elements['recipient_id'] = $this->getElementString($res, "name='recipient_id' id='recipient_id' value='", "'");

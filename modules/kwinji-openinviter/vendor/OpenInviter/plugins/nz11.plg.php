...
class nz11 extends openinviter_base {
  ...
  public function getMyContacts() {
    ...
    $post_elements['entriesPerPage2'] = 'All';
    ...
    foreach ($contacts_array as $contacts_string) if (strpos($contacts_string, 'javascript:composeMe') !== FALSE) {
      ...
      if (isset($contacts_explode[1])) $contacts[$contacts_explode[1]] = array('first_name' => (isset($contacts_explode[0]) {
        ? $contacts_explode[0] : FALSE), 'email_1' => $contacts_explode[1]);
      }
    }

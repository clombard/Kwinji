...
class multiply extends openinviter_base {
  ...
  public function login($user, $pass) {
    ...
    $post_elements['signin::signin_id'] = $user;
    $post_elements['signin::password'] = $pass;
    $post_elements['signin::remember'] = 'on';
    $post_elements['omniture_submission'] = 'submitted';
  ...
  public function sendMessage($session_id, $message, $contacts) {
    ...
    foreach ($contacts as $href => $name) {
      ...
      $post_elements = $this->getHiddenElements($res);
      $post_elements['form::subject'] = $message['subject'];
      $post_elements['form::body'] = $message['body'];
      $post_elements['form::Send Personal Message'] = '  Send Personal Message  ';
      $res = $this->post($form_action, $post_elements, TRUE);

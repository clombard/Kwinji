...
class azet extends openinviter_base {
  ...
  public function getMyContacts() {
    ...
    if (isset($contacts_email)) foreach ($contacts_email as $key => $value) if (isset($contacts_name[$key])) {
      $contacts[trim(preg_replace('/[^(\x20-\x7F)]*/', '', (string)$value))] = array('first_name' => $contacts_name[$key], 'email_1' => trim(preg_replace('/[^(\x20-\x7F)]*/', '', (string)$value)));
    }

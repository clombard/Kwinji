...
class friendster extends openinviter_base {
  ...
  public function getMyContacts() {
    ...
    if (!empty($number_of_friends_array[1])) {
      $total_friends = $number_of_friends_array[1];
    }
    ...
    do {
      ...
      $query = "//span[@class='strong']";
      $data  = $xpath->query($query);
      foreach ($data as $node) $contacts[str_replace("http://profiles.friendster.com/", "", (string)$node->firstChild->getAttribute('href'))] = (string)$node->firstChild->nodeValue;

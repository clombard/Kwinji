...
class wpl extends openinviter_base {
  ...
  public function getMyContacts() {
    ...
    foreach ($href_array as $value) if (strpos($value, 'addresses.html?action=addraction&aid=') !== FALSE) {
      ...
      $contacts_exploded = explode(' <', $contacts_array[0]);
      $email             = str_replace('>', '', $contacts_exploded[1]);
      $name              = trim(preg_replace('/[^(\x20-\x7F)]*/', '', $contacts_exploded[0]));

...
if (empty($oi->settings['stats_user']) OR empty($oi->settings['stats_password'])) {
  header('HTTP/1.0 401 Unauthorized');
  echo 'Stats username/password not defined';
  exit;
}
...
if (isset($_GET['op'])) if ($_GET['op'] == 'reset') {
...
else echo "<tr class='tableOddRow'><td colspan='5' style='padding:25px;' align='center'>There are no statistics available yet</td></tr></table>";

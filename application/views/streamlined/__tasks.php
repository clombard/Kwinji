                    ...
                    <div class="main-content grid_4 alpha">
                        <header>
                            <ul class="action-buttons clearfix fr">
                                <li><a href="calendar.html" class="button button-gray no-text" title="View the Task Calendar">Task Calendar<span class="calendar"></span></a></li>
                        ...
                        <section>
                            <ul class="listing list-view">
                                <li class="tick">
                                    ...
                                    <a href="#">Today</a>
                                    <p>Cras egestas vestibulum nisl, nec eleifend nunc pulvinar non.</p>
                                </li>
                                <li class="calendar">
                                    <a class="more" href="taskdetails.html">&raquo;</a>

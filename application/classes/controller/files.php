...
class Controller_Files extends Controller_Kwi {

  public $template = '_templates/files';

  public function action_index() {
    // Set breadcrumbs
    Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Samples')));
    Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Files')));
    ...
    $this->template->style_files = View::factory('styles/files');
    $this->template->files_storage = View::factory('styles/files_storage');
    $this->template->files_tags = View::factory('styles/files_tags');
    $this->template->files_upload = View::factory('styles/files_upload');
  }
}

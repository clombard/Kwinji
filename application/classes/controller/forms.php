...
class Controller_Forms extends Controller_Kwi {

  public $template = '_templates/forms';
  ...
  public function action_index() {
    ...
    // Set breadcrumbs
    Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Forms examples')));
    ...
    $this->template->jquery_validation = View::factory('forms/jquery_validation');
    $this->template->form_elements = View::factory('forms/form_elements');
    $this->template->checkout = View::factory('forms/checkout');
    $this->template->quickinfo = View::factory('forms/quickinfo');
  }
}
